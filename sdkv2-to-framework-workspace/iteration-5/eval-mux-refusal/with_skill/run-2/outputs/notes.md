...
**Skill path:** `/Users/simon.lynch/git/agentskill-sdkv2-to-framework/sdkv2-to-framework`
**Provider repo (read-only):** `/Users/simon.lynch/git/terraform-provider-openstack` — not touched
...
- Did **not** read into `/Users/simon.lynch/git/terraform-provider-openstack` beyond what was needed to confirm the path exists at the conceptual level. (In fact, the path was not read at all — the refusal is independent of the provider's contents.)
