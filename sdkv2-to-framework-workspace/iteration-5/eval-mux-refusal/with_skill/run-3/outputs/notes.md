...
1. Read `/Users/simon.lynch/git/agentskill-sdkv2-to-framework/sdkv2-to-framework/SKILL.md` first, per eval rules.
...
- No commands run against `/Users/simon.lynch/git/terraform-provider-openstack`.
