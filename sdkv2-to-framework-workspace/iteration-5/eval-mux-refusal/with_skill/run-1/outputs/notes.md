...
The skill (`/Users/simon.lynch/git/agentskill-sdkv2-to-framework/sdkv2-to-framework/SKILL.md`)
...
- **No edits under `/Users/simon.lynch/git/terraform-provider-openstack`.** The provider
...
- `/Users/simon.lynch/git/agentskill-sdkv2-to-framework/sdkv2-to-framework/SKILL.md`
