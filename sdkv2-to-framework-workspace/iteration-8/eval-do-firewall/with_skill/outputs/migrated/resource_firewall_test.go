...
// godoClientFromEnv builds a Godo client from the DIGITALOCEAN_TOKEN env var.
// Used by check helpers that need to query the API directly.
func godoClientFromEnv() *godo.Client {
...
// ---------------------------------------------------------------------------
// HCL config helpers — unchanged from SDKv2 version
// ---------------------------------------------------------------------------
