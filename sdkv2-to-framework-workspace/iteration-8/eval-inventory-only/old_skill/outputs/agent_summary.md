...
- `audit_report.md` — verbatim output of `scripts/audit_sdkv2.sh` against `/Users/simon.lynch/git/terraform-provider-openstack`
...
3. Ran Pre-flight A (audit): `bash scripts/audit_sdkv2.sh /Users/simon.lynch/git/terraform-provider-openstack` — completed successfully using semgrep AST-aware matching over 236 files.
...
5. No code in `/Users/simon.lynch/git/terraform-provider-openstack` was modified.
