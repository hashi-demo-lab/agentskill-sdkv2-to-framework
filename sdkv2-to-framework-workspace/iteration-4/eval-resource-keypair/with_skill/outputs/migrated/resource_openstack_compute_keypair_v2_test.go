...
// Replace NewFrameworkProvider() with whatever constructor your migrated
// provider exposes once the full provider migration is complete.
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Import verification.
			{
				...
				// private_key is only returned on Create and cannot be read
				// back from the API, so exclude it from import verification.
