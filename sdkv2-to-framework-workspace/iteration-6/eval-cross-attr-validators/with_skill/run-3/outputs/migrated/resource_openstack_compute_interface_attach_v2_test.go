...
func TestAccComputeV2InterfaceAttach_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		// Migrated from ProviderFactories (SDKv2) to ProtoV6ProviderFactories.
		// The factory variable is provided by the framework-side test scaffold
		// and wraps the migrated resource via providerserver.NewProtocol6WithError.
