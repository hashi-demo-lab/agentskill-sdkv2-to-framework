...
// TestResourceExampleInstanceStateUpgradeV0 exercises the V0->V1 raw-map
// transformation logic. The framework upgrader operates on typed state via
// resource.UpgradeStateRequest, but the underlying mapping (id -> uuid,
// name -> id) is captured by MigrateCertificateStateV0toV1 — preserved as a
// helper for this unit test.
