...
func TestAccDatabaseV1Database_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		// ProtoV6ProviderFactories. testAccProtoV6ProviderFactories is
		// the framework-protocol-v6 factory map that the migrated
		// provider exposes via providerserver.NewProtocol6WithError.
		...
		Steps: []resource.TestStep{
			...
			{
				// Round-trip import to prove ImportStatePassthroughID
				// preserves the composite "<instance_id>/<name>" ID.
