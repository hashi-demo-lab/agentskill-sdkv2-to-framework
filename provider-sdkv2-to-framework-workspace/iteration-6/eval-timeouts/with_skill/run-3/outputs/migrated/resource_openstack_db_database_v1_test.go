...
// TestAccDatabaseV1Database_basic exercises the framework-migrated
// openstack_db_database_v1 resource. The framework resource is served via
// ProtoV6ProviderFactories (defined alongside the project's mux setup); the
// SDKv2 testAccProviders factories from provider_test.go remain for resources
