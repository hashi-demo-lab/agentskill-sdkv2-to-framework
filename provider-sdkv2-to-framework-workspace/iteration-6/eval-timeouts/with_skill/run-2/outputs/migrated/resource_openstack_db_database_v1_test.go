...
// TestAccDatabaseV1Database_basic exercises the migrated framework resource
// end-to-end. The provider harness used here (testAccProviders / muxed
// factories) is established in provider_test.go for the package as a whole;
// this test does not need to know which SDK serves the resource as long as the
// schema (region/name/instance_id/timeouts) is preserved across the migration.
