...
var protoV6ProviderFactoriesComputeInterfaceAttach = map[string]func() (tfprotov6.ProviderServer, error){
...
func TestAccComputeV2InterfaceAttach_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		ProtoV6ProviderFactories: protoV6ProviderFactoriesComputeInterfaceAttach,
