...
Read `<repo>/provider-sdkv2-to-framework-workspace/skill-snapshot-i7/SKILL.md` in full. Confirmed the mux exclusion in both the "Does NOT apply" section and the "When this skill applies" pre-check block.
