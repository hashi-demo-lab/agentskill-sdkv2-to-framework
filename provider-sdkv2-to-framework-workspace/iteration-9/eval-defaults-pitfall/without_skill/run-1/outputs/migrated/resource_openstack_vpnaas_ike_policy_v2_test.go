		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIKEPolicyV2Exists(t.Context(),
						"openstack_vpnaas_ike_policy_v2.policy_1", &policy),
					resource.TestCheckResourceAttr("openstack_vpnaas_ike_policy_v2.policy_1", "lifetime.#", "1"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIKEPolicyV2Exists(t.Context(),
						"openstack_vpnaas_ike_policy_v2.policy_1", &policy),
					resource.TestCheckResourceAttr("openstack_vpnaas_ike_policy_v2.policy_1", "name", "updatedname"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIKEPolicyV2Exists(t.Context(),
						"openstack_vpnaas_ike_policy_v2.policy_1", &policy),
					resource.TestCheckResourceAttr("openstack_vpnaas_ike_policy_v2.policy_1", "auth_algorithm", "sha256"),
					resource.TestCheckResourceAttr("openstack_vpnaas_ike_policy_v2.policy_1", "pfs", "group14"),
					resource.TestCheckResourceAttr("openstack_vpnaas_ike_policy_v2.policy_1", "lifetime.#", "1"),
				),
			},
			{
