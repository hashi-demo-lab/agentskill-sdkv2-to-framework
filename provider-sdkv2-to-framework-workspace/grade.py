#!/usr/bin/env python3
"""Generic, data-driven grader for provider-sdkv2-to-framework evals.
...
# Layout
  ...
  <repo>/
    provider-sdkv2-to-framework/evals/evals.json           # eval definitions + checks
    provider-sdkv2-to-framework-workspace/
...
CLONE_BASELINE_BRANCH = "provider-sdkv2-to-framework/eval-baseline"
